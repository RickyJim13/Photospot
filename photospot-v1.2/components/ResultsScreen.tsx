...
const ResultsScreen: React.FC<ResultsScreenProps> = ({ imageSrc, analysisResult, onTryAnother }) => {
            ...
            <div className="mt-6 flex flex-col gap-3">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 space-y-3 sm:space-y-0">
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 flex items-center justify-center text-center bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-full text-lg transition-transform transform hover:scale-105 duration-300"
                >
